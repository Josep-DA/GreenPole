...
@bp.route('/mission')
def mission():
    return render_page('mission', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="Mission")
...
@bp.route('/origin')
def origin():
    return render_page('origin', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="Origin")
...
@bp.route('/founders')
def founders():
    return render_page('founders', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="Founders")
...
@bp.route('/process')
def process():
    return render_page('process', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="Process")
...
def documentation():
    return render_page('documentation', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="Documentation")
...
@bp.route('/FAQ')
def faq():
    return render_page('FAQ', website_name=WEBSITE_NAME, add_navbar_footer=True, page_title="FAQ")
